...
\begin{figure*}[t]
  ...
  \caption{\textbf{Left}: CNR in dB across six vessel ROIs.  Dower
    Coppler has median CNR 15.6~dB across the six selections
    (range 8.1--19.0~dB), compared with 13.9~dB for power Doppler.
...
Dower Coppler achieves median CNR 15.6~dB across the six tolerant
circular vessel selections, with values ranging from 8.1--19.0~dB.
Power Doppler has median CNR 13.9~dB (range 7.4--18.7~dB), and Kasai
color Doppler has median CNR -6.9~dB (range -16.8--2.1~dB) when the
...
background, the Dower Coppler sign agreed for 76.6\% of 13,786 finite
nonzero pixels.  Restricting the comparison to the highest-magnitude
pixels gave substantially higher agreement: 97.8\% for the top 10\%
of pixels and 98.4\% for the top 5\%.  In the tolerant circular
vessel ROIs used for the CNR analysis, the sign agreed between halves
for 98.0\% of finite nonzero pixels (248 pixels; 250 total ROI pixels).
...
\begin{figure*}[t]
  ...
  \caption{Dower Coppler maps computed from different numbers of
    ...
    vessels remain identifiable but background noise increases.  Images
    are cropped to the lateral range $-1.5$ to $1.5$~cm.}
  \label{fig:stability}
\end{figure*}
