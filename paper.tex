...
background region for all three displays, with Dower Coppler and power
Doppler at approximately 1.0 across all selections.
...
and compared signs in the same circular vessel ROIs on the closest
available elevation plane ($y=-0.44$~mm).  The Dower Coppler sign was
identical between halves for all 130 vessel-ROI pixels.
