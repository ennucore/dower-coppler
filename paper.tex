...
relative to the Kasai estimator.  We demonstrate the method
\textit{in~vivo} on intact-skull transcranial human 3D fUS data,
acquired without a cranial window.  Across the reconstructed elevation
volume, Dower Coppler reveals opposing flow directions in adjacent
cortical vessels that are not visible in conventional power Doppler.
\end{abstract}
...
transcranial 3D functional ultrasound imaging of human cortex.
...
and with flow phantoms providing ground-truth velocity fields is
needed.  Dower Coppler is not itself a quantitative velocity image:
