...
rate of \SI{1240.9}{\hertz} over the full ultratrace; because each
compounded frame used five transmit angles, the corresponding
compounded-frame cadence was approximately \SI{248.2}{\hertz}.  The assumed sound speed was
...
\begin{figure*}[t]
  ...
  \caption{\textbf{Left}: CNR in dB across six vessel ROIs.  Dower
    Coppler has median CNR 14.0~dB across the six selections
    (range 8.8--21.8~dB), compared with 4.7~dB for power Doppler.
...
Dower Coppler achieves median CNR 14.0~dB across the six tolerant
circular vessel selections, with values ranging from 8.8--21.8~dB.
Power Doppler has median CNR 4.7~dB (range -8.0--7.7~dB), and Kasai
color Doppler has median CNR 12.2~dB (range 7.8--14.1~dB) when the
signed Doppler maps are measured by magnitude, as in the viewer CNR
calculation.  The smallest tolerant circles contain five pixels, rather
...
\begin{figure*}[t]
  ...
  \caption{Dower Coppler maps computed from different numbers of
    ...
    and flow direction assignment remain stable from the full
...
\begin{figure*}[t]
  ...
  \caption{Dower Coppler maps across elevation planes 2--7 from the
    ...
    10 elevation planes.  The panels use all 480 acquisitions and one
    shared symmetric color scale computed from the 97th percentile of
    absolute Dower Coppler values across the displayed planes.  Images
    are cropped to the lateral range $-1.5$ to $1.5$~cm.  The directional vascular
